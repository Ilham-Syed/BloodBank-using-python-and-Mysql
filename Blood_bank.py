...
db = mysql.connector.connect(host ="localhost",user = "root",password = 'tiger',database='db')
...
greet = Label(window, font = ('arial', 20, 'bold'), text = "Welcome to Blood Donation Window!")
...
def Donate_dbase():
    ...
    #setting database connection
    dbase = mysql.connector.connect(host ="localhost",user = "root",password = 'tiger',database='db')
    cursor = dbase.cursor()
...
def Request_dbase():
    ...
    #setting database connection
    dbase = mysql.connector.connect(host ="localhost",user = "root",password = 'tiger',database='dbase')
    cursor = dbase.cursor()
